...
Each asset = free ungated diagnostic front door + paid Supabase-backed engagement workspace. Full design: `docs/BLUEPRINT.md`.
...
- **Brand isolation:** ATM assets only. Never copy content, code or links from StoryC/storycltd or BDO repositories.

## Build sequence

Sprint 1: diagnostic front doors (no Supabase) · Sprint 2: Supabase spine (schema in `docs/BLUEPRINT.md` §5) · Sprint 3: Exit Ready workspace · Sprint 4: Deal Ready pipeline · Sprint 5: advisor console.
