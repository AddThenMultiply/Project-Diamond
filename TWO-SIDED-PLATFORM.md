...
A deep research pass on both personas' needs, wants and fears (founder-side: growth-by-acquisition and exit; capital-side: PE, growth equity, family offices, strategic buyers — criteria, dealbreakers, why deals die) is in progress and will be used to refine the intake and mandate fields. The current fields are grounded in the two ATM process documents and both books; research findings land as a v2 of the question sets, not a redesign.
